...
public class DvfSpriteDecoder {
	...
	public DvfSpriteDecoder(short width, short height, byte[] data) {
		this.width = width;
		this.height = height;
		this.data = data;
	}
	...
	public ImageData getImageData() {
		...
		ImageData imageData = new ImageData(width, height, 24, new PaletteData(0xFF, 0xFF00, 0xFF0000), 4, bmp);
		imageData.setAlphas(0, 0, width * height, mask, 0);
		return imageData;
	}

	public static void createPNG(int index, String outputPath, String dvfName, ImageData imageData) {
